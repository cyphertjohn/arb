...
module Bindings (F : Cstubs.FOREIGN) = struct
  ...
  let fmpz_init_set = foreign "fmpz_init_set" (fmpz_t @-> fmpz_t @-> returning void)
  let fmpz_init_set_si = foreign "fmpz_init_set_si" (fmpz_t @-> long @-> returning void)
  let fmpz_set_si = foreign "fmpz_set_si" (fmpz_t @-> long @-> returning void)
  let fmpz_get_si = foreign "fmpz_get_si" (fmpz_t @-> returning long)
  let fmpz_zero = foreign "fmpz_zero" (fmpz_t @-> returning void)
  let fmpz_one = foreign "fmpz_one" (fmpz_t @-> returning void)
  let fmpz_cmp = foreign "fmpz_cmp" (fmpz_t @-> fmpz_t @-> returning int)
  let fmpz_cmp_si = foreign "fmpz_cmp_si" (fmpz_t @-> long @-> returning int)
  let fmpz_equal = foreign "fmpz_equal" (fmpz_t @-> fmpz_t @-> returning int)
  let fmpz_equal_si = foreign "fmpz_equal_si" (fmpz_t @-> long @-> returning int)
  let fmpz_neg = foreign "fmpz_neg" (fmpz_t @-> fmpz_t @-> returning void)
  let fmpz_add = foreign "fmpz_add" (fmpz_t @-> fmpz_t @-> fmpz_t @-> returning void)
  let fmpz_add_si = foreign "fmpz_add_si" (fmpz_t @-> fmpz_t @-> long @-> returning void)
  let fmpz_sub = foreign "fmpz_sub" (fmpz_t @-> fmpz_t @-> fmpz_t @-> returning void)
  let fmpz_sub_si = foreign "fmpz_sub_si" (fmpz_t @-> fmpz_t @-> long @-> returning void)
  let fmpz_mul = foreign "fmpz_mul" (fmpz_t @-> fmpz_t @-> fmpz_t @-> returning void)
  let fmpz_mul_si = foreign "fmpz_mul_si" (fmpz_t @-> fmpz_t @-> long @-> returning void)
  let fmpz_divexact = foreign "fmpz_divexact" (fmpz_t @-> fmpz_t @-> fmpz_t @-> returning void)
  let fmpz_divexact_si = foreign "fmpz_divexact_si" (fmpz_t @-> fmpz_t @-> long @-> returning void)
  let fmpz_pow_ui = foreign "fmpz_pow_ui" (fmpz_t @-> fmpz_t @-> ulong @-> returning void)
  let fmpz_gcd = foreign "fmpz_gcd" (fmpz_t @-> fmpz_t @-> fmpz_t @-> returning void)
  let fmpz_lcm = foreign "fmpz_lcm" (fmpz_t @-> fmpz_t @-> fmpz_t @-> returning void)
  ...
  let fmpz_mat_window_init = foreign "fmpz_mat_window_init" (fmpz_mat_t @-> fmpz_mat_t @-> long @-> long @-> long @-> long @-> returning void)
  let fmpz_mat_window_clear = foreign "fmpz_mat_window_clear" (fmpz_mat_t @-> returning void)
  let fmpz_mat_zero = foreign "fmpz_mat_zero" (fmpz_mat_t @-> returning void)
  let fmpz_mat_init_set = foreign "fmpz_mat_init_set" (fmpz_mat_t @-> fmpz_mat_t @-> returning void)
  let fmpz_mat_equal = foreign "fmpz_mat_equal" (fmpz_mat_t @-> fmpz_mat_t @-> returning int)
  let fmpz_mat_is_zero = foreign "fmpz_mat_is_zero" (fmpz_mat_t @-> returning int)
  let fmpz_mat_transpose = foreign "fmpz_mat_transpose" (fmpz_mat_t @-> fmpz_mat_t @-> returning void)
  let fmpz_mat_concat_vertical = foreign "fmpz_mat_concat_vertical" (fmpz_mat_t @-> fmpz_mat_t @-> fmpz_mat_t @-> returning void)
  let fmpz_mat_concat_horizontal = foreign "fmpz_mat_concat_horizontal" (fmpz_mat_t @-> fmpz_mat_t @-> fmpz_mat_t @-> returning void)
  let fmpz_mat_add = foreign "fmpz_mat_add" (fmpz_mat_t @-> fmpz_mat_t @-> fmpz_mat_t @-> returning void)
  let fmpz_mat_sub = foreign "fmpz_mat_sub" (fmpz_mat_t @-> fmpz_mat_t @-> fmpz_mat_t @-> returning void)
  let fmpz_mat_neg = foreign "fmpz_mat_neg" (fmpz_mat_t @-> fmpz_mat_t @-> returning void)
  let fmpz_mat_scalar_mul_si = foreign "fmpz_mat_scalar_mul_si" (fmpz_mat_t @-> fmpz_mat_t @-> long @-> returning void)
  let fmpz_mat_scalar_mul_fmpz = foreign "fmpz_mat_scalar_mul_fmpz" (fmpz_mat_t @-> fmpz_mat_t @-> fmpz_t @-> returning void)
  let fmpz_mat_scalar_divexact_si = foreign "fmpz_mat_scalar_divexact_si" (fmpz_mat_t @-> fmpz_mat_t @-> long @-> returning void)
  let fmpz_mat_scalar_divexact_fmpz = foreign "fmpz_mat_scalar_divexact_fmpz" (fmpz_mat_t @-> fmpz_mat_t @-> fmpz_t @-> returning void)
  let fmpz_mat_scalar_mul_2exp = foreign "fmpz_mat_scalar_mul_2exp" (fmpz_mat_t @-> fmpz_mat_t @-> ulong @-> returning void)
  let fmpz_mat_scalar_tdiv_q_2exp = foreign "fmpz_mat_scalar_tdiv_q_2exp" (fmpz_mat_t @-> fmpz_mat_t @-> ulong @-> returning void)
  let fmpz_mat_mul = foreign "fmpz_mat_mul" (fmpz_mat_t @-> fmpz_mat_t @-> fmpz_mat_t @-> returning void)
  let fmpz_mat_pow = foreign "fmpz_mat_pow" (fmpz_mat_t @-> fmpz_mat_t @-> ulong @-> returning void)
  let fmpz_mat_content = foreign "fmpz_mat_content" (fmpz_t @-> fmpz_mat_t @-> returning void)
  let fmpz_mat_trace = foreign "fmpz_mat_trace" (fmpz_t @-> fmpz_mat_t @-> returning void)
  let fmpz_mat_hnf = foreign "fmpz_mat_hnf" (fmpz_mat_t @-> fmpz_mat_t @-> returning void)
  let fmpz_mat_hnf_transform = foreign "fmpz_mat_hnf_transform" (fmpz_mat_t @-> fmpz_mat_t @-> fmpz_mat_t @-> returning void)
  let fmpz_mat_is_in_hnf = foreign "fmpz_mat_is_in_hnf" (fmpz_mat_t @-> returning int)
